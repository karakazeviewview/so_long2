...
void	render_img(t_vars **vars)
{
	...
	(*vars)->e_vars.imgs[0] = "./img2/T_e_1.xpm";
	(*vars)->e_vars.imgs[1] = "./img2/T_e_2.xpm";
	(*vars)->e_vars.imgs[2] = "./img2/T_e_3.xpm";
	(*vars)->e_vars.imgs[3] = "./img2/T_e_2.xpm";
	(*vars)->e_vars.imgs[4] = "./img2/T_e_1.xpm";
	(*vars)->img = mlx_xpm_file_to_image(
			(*vars)->mlx, "./img2/floor.xpm", &img_w, &img_h);
