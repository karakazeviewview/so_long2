...
{
	if (p == '1')
		put_image(&v, x1, y1, "./img2/wall.xpm");
	else if (p == 'C')
	{
		put_image(&v, x1, y1, "./img2/floor.xpm");
		put_image(&v, x1, y1, "./img2/T_collect.xpm");
		(*v)->collect++;
	}
	else if (p == 'E')
		put_image(&v, x1, y1, "./img2/exit.xpm");
	else if (p == 'P')
	{
		(*v)->y_p = y1;
		(*v)->x_p = x1;
		put_image(&v, x1, y1, "./img2/floor.xpm");
		put_image(&v, x1, y1, "./img2/T_front.xpm");
	}
	else
		put_image(&v, x1, y1, "./img2/floor.xpm");
}
